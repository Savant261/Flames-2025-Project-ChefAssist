    ...
    return (
        <section id="testimonials" className="max-w-7xl mx-auto mb-16 px-6 py-16 bg-[#FEF2D7] dark:bg-[#FEF2D7] rounded-[2.5rem] shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="testimonial-card opacity-0 translate-y-8 transition-all duration-700 rounded-2xl bg-white p-8 shadow-md border border-[#E5C6B0] flex flex-col items-center text-center">
