            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 md:gap-0">
                ...
                <div className="flex-1 min-w-[220px] mb-8 md:mb-0">
                    <div className="flex items-center gap-3 mb-3">
                        <span className="inline-flex items-center justify-center rounded-full bg-[#FF6F61]/20 border-2 border-[#FF6F61] p-2" style={{ boxshadow: "0 2px 8px #FF6F6130" }}>
                        ...
                        <span className="text-2xl font-bold" style={{ color: "#FF6F61", fontfamily: "Poppins,Arial,sans-serif" }}>ChefAI</span>
                    </div>
                    <p className="text-[#6B4F3A] text-base font-medium mb-4" style={{ color: "#FF6F61", fontfamily: "Poppins,Arial,sans-serif" }}>ChefAI helps you create delicious, healthy recipes in seconds using AI. Plan meals, get nutritional info, and explore cuisines—all in one elegant app.</p>
                    <div className="flex gap-3 mt-2">
                        <a href="#" className="group"><span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#E5C6B0] text-[#FF6F61] shadow-md transition hover:bg-[#FF6F61] hover:text-white animate-jump" style={{ fontsize: "1.3rem" }}><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm.75 3A2.25 2.25 0 0 0 6.25 7.25v9.5A2.25 2.25 0 0 0 8.75 19h6.5A2.25 2.25 0 0 0 17.75 16.75v-9.5A2.25 2.25 0 0 0 15.25 5h-6.5z" /></svg></span></a>
                ...
                <div className="flex-1 min-w-[160px] mb-8 md:mb-0">
                    <h4 className="font-bold text-lg mb-3 text-[#D35400]">Quick Links</h4>
                    <ul className="flex flex-col gap-1 text-[#6B4F3A]">
                        <li><a href="#flow-usage" className="hover:text-[#FF6F61] transition" onclick="event.preventDefault();document.getElementById('flow-usage').scrollIntoView({behavior: 'smooth'});">Instructions</a></li>
                        <li><a href="#features-chefai" className="hover:text-[#FF6F61] transition" onclick="event.preventDefault();document.getElementById('features-chefai').scrollIntoView({behavior: 'smooth'});">Features</a></li>
                        <li><a href="#footer-chefai" className="hover:text-[#FF6F61] transition">Contact Us</a></li>
                    </ul>
                </div>
                {/* <!-- Contact Info --> */}
                <div className="flex-1 min-w-[220px] mb-8 md:mb-0">
                    <h4 className="font-bold text-lg mb-3 text-[#D35400]">Contact</h4>
                    <ul className="text-[#6B4F3A] text-base flex flex-col gap-2">
                ...
                <div className="flex-1 min-w-[220px]">
                    <h4 className="font-bold text-lg mb-3 text-[#D35400]">Stay Updated</h4>
                    <form className="flex gap-2">
                        <input type="email" placeholder="Your email" className="px-4 py-2 rounded-lg border border-[#E5C6B0] bg-white text-[#D35400] focus:outline-none focus:ring-2 focus:ring-[#FF6F61] flex-1" />
                        <button type="submit" className="px-5 py-2 rounded-lg bg-[#FF6F61] text-white font-bold hover:bg-[#D35400] transition">Subscribe</button>
                    </form>
                </div>
            </div>
            <div className="w-full text-center mt-10 text-[#B35C00] text-sm opacity-70" style={{ color: "#FF6F61", fontfamily: "Poppins,Arial,sans-serif" }}>
