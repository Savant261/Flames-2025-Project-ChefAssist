                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="relative">
                                    <button
                                        type="button"
                                        id="cuisineDropdown"
                                        onClick="toggleDropdown('cuisineOptions')"
                                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-chef-orange focus:border-transparent text-left flex items-center justify-between"
                                    >
                                    ...
                                    >
                                        <div className="p-2 space-y-1">
                                            <label className="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                                                <input
                                                    ...
                                                    value="italian"
                                                    defaultChecked
                                                    className="mr-3 text-chef-orange focus:ring-chef-orange"
                                                />
                                                <span>🍝 Italian</span>
                                            </label>
                                            <label className="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                                        ...
                                        <div className="border-t p-2">
                                            <input
                                                ...
                                                className="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-chef-orange focus:border-transparent"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-4">
                                    ...
                                    <button
                                        type="button"
                                        onClick="showDietaryInfo()"
                                        className="ml-2 text-chef-orange hover:text-chef-orange-dark"
                                    >
                                        <svg
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    <label className="flex items-center p-3 border border-gray-300 rounded-lg hover:border-chef-orange cursor-pointer transition-colors">
                                        <input
                                            type="checkbox"
                                            name="dietary"
                                            value="vegetarian"
                                ...
                                <input
                                    ...
                                    className="w-full mt-3 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-chef-orange focus:border-transparent"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8 border border-chef-peach/30">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                <div className="flex-1">
                                    <h3 className="font-medium text-gray-900">Recipe Alerts</h3>
                                    <p className="text-sm text-gray-500">
                                        Get notified about new recipes from chefs you follow
                                    </p>
                                    <select className="mt-2 text-xs text-gray-600 border-none bg-transparent p-0 focus:ring-0">
                                        <option>Daily</option>
                            ...
                            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Weekly cooking tips and featured recipes
                                    </p>
                                    <select className="mt-2 text-xs text-gray-600 border-none bg-transparent p-0 focus:ring-0">
                                        <option selected>Weekly</option>
                                        <option>Monthly</option>
                            ...
                            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                <div className="flex-1">
                                    <h3 className="font-medium text-gray-900">Comments & Reviews</h3>
                                    <p className="text-sm text-gray-500">
                                        When someone comments on or reviews your recipes
                                    </p>
                                    <select className="mt-2 text-xs text-gray-600 border-none bg-transparent p-0 focus:ring-0">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8 border border-chef-peach/30">
                        ...
                        <div className="space-y-4">
                            <button
                                ...
                                className="w-full text-left py-3 px-4 rounded-lg bg-red-100 text-red-700 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition-colors"
                            >
