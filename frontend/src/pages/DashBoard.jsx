            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-chef-peach/30 sticky top-24">
                            ...
                            <nav className="space-y-2">
                                <button className="nav-item active w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="overview">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z" />
                                    </svg>
                                    Overview
                                </button>
                                <button className="nav-item w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="my-recipes">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253z" />
                                    </svg>
                                    My Recipes
                                </button>
                                <button className="nav-item w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="meal-planner">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                    Meal Planner
                                </button>
                                <button className="nav-item w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="inventory">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                    </svg>
                                    Inventory
                                </button>
                                <button className="nav-item w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="nutrition">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                    </svg>
                                    Nutrition
                                </button>
                                <button className="nav-item w-full text-left px-4 py-3 rounded-lg transition-colors" data-section="settings">
                                    <svg className="w-5 h-5 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="lg:col-span-3">
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-chef-peach/30 mb-8">
                                ...
                                <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
                                        ...
                                        <div id="inspirationWheel" className="w-48 h-48 rounded-full border-8 border-chef-orange relative overflow-hidden cursor-pointer">
                                            ...
                                            <div className="absolute inset-4 bg-white rounded-full flex items-center justify-center">
                                                <div className="text-center">
                                                    ...
                                                    <div className="font-bold text-chef-orange">Spin Me!</div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex-1">
                                        <div id="wheelResult" className="hidden">
                                            ...
                                            <div id="suggestedRecipe" className="bg-chef-cream p-4 rounded-lg">
                                                {/* <!-- Suggested recipe will appear here --> */}
                                            </div>
                                        </div>
                                        <div id="wheelInstructions" className="text-gray-600">
                        ...
                        {/* <!-- My Recipes Section --> */}
                        <div id="my-recipes-section" className="dashboard-section hidden">
                            ...
                            <div className="bg-white rounded-xl shadow-lg border border-chef-peach/30 mb-8">
                                <div className="border-b border-gray-200">
                                    <nav className="flex space-x-8 px-6">
                                        <button className="recipe-tab active py-4 px-2 border-b-2 border-chef-orange text-chef-orange font-medium" data-tab="published">
                                            Published (24)
                                        </button>
                                        <button className="recipe-tab py-4 px-2 border-b-2 border-transparent text-gray-500 hover:text-chef-orange" data-tab="drafts">
                                            Drafts (3)
                                        </button>
                                        <button className="recipe-tab py-4 px-2 border-b-2 border-transparent text-gray-500 hover:text-chef-orange" data-tab="alerts">
                                            Alerts (2)
                                        </button>
                                    </nav>
                                </div>
                                ...
                                <div className="p-6">
                                    <div id="published-tab" className="recipe-tab-content">
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="publishedRecipes">
                                            {/* <!-- Published recipes will be populated here --> */}
                                        </div>
                                    </div>

                                    <div id="drafts-tab" className="recipe-tab-content hidden">
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="draftRecipes">
                                            {/* <!-- Draft recipes will be populated here --> */}
                                        </div>
                                    </div>

                                    <div id="alerts-tab" className="recipe-tab-content hidden">
                                        <div className="space-y-4" id="recipeAlerts">
                                            {/* <!-- Recipe alerts will be populated here --> */}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="meal-planner-section" className="dashboard-section hidden">
                        ...
                        {/* <!-- Inventory Section --> */}
                        <div id="inventory-section" className="dashboard-section hidden">
                            <div className="flex items-center justify-between mb-6">
                        ...
                        {/* <!-- Nutrition Section --> */}
                        <div id="nutrition-section" className="dashboard-section hidden">
                        ...
                        {/* <!-- Settings Section --> */}
                        <div id="settings-section" className="dashboard-section hidden">
