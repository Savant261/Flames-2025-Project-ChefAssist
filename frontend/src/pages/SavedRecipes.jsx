...
import { Bookmark, Share2, Clock, Star, ChefHat } from 'lucide-react';
...
const SavedRecipes = ({ onViewRecipe }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FEF3E2]">
      {/* Header Banner */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#D97706] via-[#F59E0B] to-[#FED7AA]">
            ...
            >
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-3 right-3 p-2 rounded-full bg-[#D97706] transition-transform duration-200 hover:scale-110"
                >
              ...
              <div className="p-5">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 py-2 px-4 bg-[#D97706] hover:bg-[#B45309] rounded-lg font-medium text-white transition-colors duration-200"
                  >
                    View Recipe
                  </button>
                  <button
                    onClick={() => shareRecipe(recipe.title)}
                    className="p-2 border-2 border-[#D97706] rounded-lg transition-colors duration-200 hover:bg-[#FEF3E2]"
                  >
        ...
        {visibleRecipes < recipes.length && (
          <div className="text-center mt-12">
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-[#D97706] to-[#F59E0B] hover:from-[#B45309] hover:to-[#D97706] rounded-xl text-white font-semibold text-lg shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
